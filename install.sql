...
@@application/shared_components/files/jquery_maskedinput_js.sql
@@application/shared_components/files/util_js.sql
@@application/shared_components/files/util_css.sql
@@application/plugin_settings.sql
@@application/shared_components/security/authorizations/direitos_para_administradores.sql
@@application/shared_components/security/authorizations/direitos_de_administração.sql
@@application/shared_components/security/app_access_control/admin_barbie_apex.sql
...
@@application/shared_components/security/authentications/autenticação_customizada.sql
...
@@application/shared_components/data_loads/carga_de_dados_cliente.sql
