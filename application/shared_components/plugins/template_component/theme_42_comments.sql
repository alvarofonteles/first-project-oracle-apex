...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(8087221632021767)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1807972714096053484)
,p_plugin_id=>wwv_flow_imp.id(8087221632021767)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8087687521021768)
,p_plugin_id=>wwv_flow_imp.id(8087221632021767)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8088042753021768)
,p_plugin_id=>wwv_flow_imp.id(8087221632021767)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8088321495021768)
,p_plugin_id=>wwv_flow_imp.id(8087221632021767)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8088657170021768)
,p_plugin_id=>wwv_flow_imp.id(8087221632021767)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8088901234021770)
,p_plugin_id=>wwv_flow_imp.id(8087221632021767)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8093495589021771)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1807972714096053484)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8089242288021770)
,p_plugin_attribute_id=>wwv_flow_imp.id(8088901234021770)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8089611214021770)
,p_plugin_attribute_id=>wwv_flow_imp.id(8088901234021770)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8090008735021770)
,p_plugin_attribute_id=>wwv_flow_imp.id(8088901234021770)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8090377386021770)
,p_plugin_id=>wwv_flow_imp.id(8087221632021767)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8088901234021770)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8090698114021770)
,p_plugin_id=>wwv_flow_imp.id(8087221632021767)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(8090377386021770)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8091031732021770)
,p_plugin_id=>wwv_flow_imp.id(8087221632021767)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8091261650021770)
,p_plugin_id=>wwv_flow_imp.id(8087221632021767)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8091625745021770)
,p_plugin_id=>wwv_flow_imp.id(8087221632021767)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8091922960021771)
,p_plugin_attribute_id=>wwv_flow_imp.id(8091625745021770)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8092319143021771)
,p_plugin_attribute_id=>wwv_flow_imp.id(8091625745021770)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8092715739021771)
,p_plugin_attribute_id=>wwv_flow_imp.id(8091625745021770)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8093072643021771)
,p_plugin_attribute_id=>wwv_flow_imp.id(8091625745021770)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8093495589021771)
,p_plugin_id=>wwv_flow_imp.id(8087221632021767)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8093806219021771)
,p_plugin_id=>wwv_flow_imp.id(8087221632021767)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8094113494021771)
,p_plugin_attribute_id=>wwv_flow_imp.id(8093806219021771)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8094525258021771)
,p_plugin_attribute_id=>wwv_flow_imp.id(8093806219021771)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8094954554021771)
,p_plugin_id=>wwv_flow_imp.id(8087221632021767)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1808105381529154987)
,p_plugin_id=>wwv_flow_imp.id(8087221632021767)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1808104790024147530)
,p_plugin_id=>wwv_flow_imp.id(8087221632021767)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1808160413694129409)
,p_plugin_id=>wwv_flow_imp.id(8087221632021767)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1808312631407000180)
,p_plugin_id=>wwv_flow_imp.id(8087221632021767)
