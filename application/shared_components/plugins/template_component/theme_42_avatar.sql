...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(8069710223021734)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8070010898021743)
,p_plugin_id=>wwv_flow_imp.id(8069710223021734)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8070278856021745)
,p_plugin_attribute_id=>wwv_flow_imp.id(8070010898021743)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8070726517021745)
,p_plugin_attribute_id=>wwv_flow_imp.id(8070010898021743)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8071133431021745)
,p_plugin_attribute_id=>wwv_flow_imp.id(8070010898021743)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8071556509021746)
,p_plugin_id=>wwv_flow_imp.id(8069710223021734)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8070010898021743)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8071777051021746)
,p_plugin_id=>wwv_flow_imp.id(8069710223021734)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8071556509021746)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8072132216021746)
,p_plugin_id=>wwv_flow_imp.id(8069710223021734)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8072427976021746)
,p_plugin_id=>wwv_flow_imp.id(8069710223021734)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8072755481021746)
,p_plugin_id=>wwv_flow_imp.id(8069710223021734)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8073050610021746)
,p_plugin_attribute_id=>wwv_flow_imp.id(8072755481021746)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8073412373021746)
,p_plugin_attribute_id=>wwv_flow_imp.id(8072755481021746)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8073836207021746)
,p_plugin_attribute_id=>wwv_flow_imp.id(8072755481021746)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8074215210021748)
,p_plugin_id=>wwv_flow_imp.id(8069710223021734)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8074551266021748)
,p_plugin_attribute_id=>wwv_flow_imp.id(8074215210021748)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8074907820021748)
,p_plugin_attribute_id=>wwv_flow_imp.id(8074215210021748)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8075314504021748)
,p_plugin_attribute_id=>wwv_flow_imp.id(8074215210021748)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8075757922021748)
,p_plugin_attribute_id=>wwv_flow_imp.id(8074215210021748)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8076101616021748)
,p_plugin_attribute_id=>wwv_flow_imp.id(8074215210021748)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8076510568021748)
,p_plugin_attribute_id=>wwv_flow_imp.id(8074215210021748)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8076878875021748)
,p_plugin_attribute_id=>wwv_flow_imp.id(8074215210021748)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8077314668021748)
,p_plugin_id=>wwv_flow_imp.id(8069710223021734)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1808120523195135486)
,p_plugin_id=>wwv_flow_imp.id(8069710223021734)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
