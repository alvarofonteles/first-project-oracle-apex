...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(8097255110021776)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1935335076783093471)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1935334521771093470)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8097955788021778)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8098199762021778)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8098502844021778)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8098764900021778)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8099079089021778)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8099431445021778)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8099720015021778)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8099079089021778)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1935335076783093471)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8100049558021779)
,p_plugin_attribute_id=>wwv_flow_imp.id(8099720015021778)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8100440715021779)
,p_plugin_attribute_id=>wwv_flow_imp.id(8099720015021778)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8100843321021779)
,p_plugin_attribute_id=>wwv_flow_imp.id(8099720015021778)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8101169524021779)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8099720015021778)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8101501135021779)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(8101169524021779)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8101808227021779)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8102120970021779)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8102388901021779)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8102665462021779)
,p_plugin_attribute_id=>wwv_flow_imp.id(8102388901021779)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8103070728021781)
,p_plugin_attribute_id=>wwv_flow_imp.id(8102388901021779)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8103504188021781)
,p_plugin_attribute_id=>wwv_flow_imp.id(8102388901021779)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8103947057021781)
,p_plugin_attribute_id=>wwv_flow_imp.id(8102388901021779)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8104353767021781)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(8099431445021778)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1935334521771093470)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8104560398021781)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8104870151021781)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8105255412021781)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8105544290021781)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8105844238021782)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8106092136021782)
,p_plugin_attribute_id=>wwv_flow_imp.id(8105844238021782)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8106547401021782)
,p_plugin_attribute_id=>wwv_flow_imp.id(8105844238021782)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8106875301021782)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8107246507021782)
,p_plugin_attribute_id=>wwv_flow_imp.id(8106875301021782)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8107576045021782)
,p_plugin_attribute_id=>wwv_flow_imp.id(8106875301021782)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8108048115021782)
,p_plugin_attribute_id=>wwv_flow_imp.id(8106875301021782)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8108410565021782)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8108668035021782)
,p_plugin_attribute_id=>wwv_flow_imp.id(8108410565021782)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8109087717021784)
,p_plugin_attribute_id=>wwv_flow_imp.id(8108410565021782)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8109521249021784)
,p_plugin_attribute_id=>wwv_flow_imp.id(8108410565021782)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8109892314021784)
,p_plugin_attribute_id=>wwv_flow_imp.id(8108410565021782)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8110315440021784)
,p_plugin_attribute_id=>wwv_flow_imp.id(8108410565021782)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8110740986021784)
,p_plugin_attribute_id=>wwv_flow_imp.id(8108410565021782)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8111062785021784)
,p_plugin_attribute_id=>wwv_flow_imp.id(8108410565021782)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8111492783021785)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8111783904021785)
,p_plugin_attribute_id=>wwv_flow_imp.id(8111492783021785)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8112173498021785)
,p_plugin_attribute_id=>wwv_flow_imp.id(8111492783021785)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8112594615021785)
,p_plugin_attribute_id=>wwv_flow_imp.id(8111492783021785)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8113006438021785)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8113265283021785)
,p_plugin_attribute_id=>wwv_flow_imp.id(8113006438021785)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8113743198021785)
,p_plugin_attribute_id=>wwv_flow_imp.id(8113006438021785)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8114089922021785)
,p_plugin_attribute_id=>wwv_flow_imp.id(8113006438021785)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8114477847021785)
,p_plugin_attribute_id=>wwv_flow_imp.id(8113006438021785)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8114928031021787)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1816548966998915085)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1816550226518919233)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1802955338324508352)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1803634639054591456)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1816547031931870099)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1816548365321883956)
,p_plugin_id=>wwv_flow_imp.id(8097255110021776)
