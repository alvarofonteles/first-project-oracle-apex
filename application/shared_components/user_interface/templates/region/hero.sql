...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8010986045021684)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8011324113021684)
,p_plug_template_id=>wwv_flow_imp.id(8010986045021684)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8011641624021684)
,p_plug_template_id=>wwv_flow_imp.id(8010986045021684)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8011880564021684)
,p_plug_template_id=>wwv_flow_imp.id(8010986045021684)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8012182951021685)
,p_plug_template_id=>wwv_flow_imp.id(8010986045021684)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8012507983021685)
,p_plug_template_id=>wwv_flow_imp.id(8010986045021684)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
