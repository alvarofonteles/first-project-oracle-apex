...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7967006383021654)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7967290685021656)
,p_plug_template_id=>wwv_flow_imp.id(7967006383021654)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7967586251021656)
,p_plug_template_id=>wwv_flow_imp.id(7967006383021654)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7967901389021656)
,p_plug_template_id=>wwv_flow_imp.id(7967006383021654)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7968161247021656)
,p_plug_template_id=>wwv_flow_imp.id(7967006383021654)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7968509601021656)
,p_plug_template_id=>wwv_flow_imp.id(7967006383021654)
,p_name=>'Sub Regions'
