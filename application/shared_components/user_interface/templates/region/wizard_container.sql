...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7994307224021674)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7994626838021674)
,p_plug_template_id=>wwv_flow_imp.id(7994307224021674)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7994878527021674)
,p_plug_template_id=>wwv_flow_imp.id(7994307224021674)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7995180183021674)
,p_plug_template_id=>wwv_flow_imp.id(7994307224021674)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7995483010021674)
,p_plug_template_id=>wwv_flow_imp.id(7994307224021674)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7995769086021674)
,p_plug_template_id=>wwv_flow_imp.id(7994307224021674)
