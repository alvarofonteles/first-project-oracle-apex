...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7971580507021657)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7971885181021657)
,p_plug_template_id=>wwv_flow_imp.id(7971580507021657)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7972185915021657)
,p_plug_template_id=>wwv_flow_imp.id(7971580507021657)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7972503486021659)
,p_plug_template_id=>wwv_flow_imp.id(7971580507021657)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7972823584021659)
,p_plug_template_id=>wwv_flow_imp.id(7971580507021657)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7973105053021659)
,p_plug_template_id=>wwv_flow_imp.id(7971580507021657)
,p_name=>'Sub Regions'
