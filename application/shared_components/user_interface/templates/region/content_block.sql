...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7946778407021645)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7947118201021645)
,p_plug_template_id=>wwv_flow_imp.id(7946778407021645)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7947394366021645)
,p_plug_template_id=>wwv_flow_imp.id(7946778407021645)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7947660850021645)
,p_plug_template_id=>wwv_flow_imp.id(7946778407021645)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7948010653021645)
,p_plug_template_id=>wwv_flow_imp.id(7946778407021645)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7948270068021645)
,p_plug_template_id=>wwv_flow_imp.id(7946778407021645)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7948576032021645)
,p_plug_template_id=>wwv_flow_imp.id(7946778407021645)
,p_name=>'Sub Regions'
