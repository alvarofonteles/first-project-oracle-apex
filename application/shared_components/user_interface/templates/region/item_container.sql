...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7969063655021656)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7969363955021656)
,p_plug_template_id=>wwv_flow_imp.id(7969063655021656)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7969737164021656)
,p_plug_template_id=>wwv_flow_imp.id(7969063655021656)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7970051739021656)
,p_plug_template_id=>wwv_flow_imp.id(7969063655021656)
,p_name=>'Button Start'
