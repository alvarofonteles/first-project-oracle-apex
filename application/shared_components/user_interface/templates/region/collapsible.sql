...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8001212578021679)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8001532156021679)
,p_plug_template_id=>wwv_flow_imp.id(8001212578021679)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8001849767021679)
,p_plug_template_id=>wwv_flow_imp.id(8001212578021679)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8002139275021679)
,p_plug_template_id=>wwv_flow_imp.id(8001212578021679)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8002451203021679)
,p_plug_template_id=>wwv_flow_imp.id(8001212578021679)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8002703251021679)
,p_plug_template_id=>wwv_flow_imp.id(8001212578021679)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8002991187021679)
,p_plug_template_id=>wwv_flow_imp.id(8001212578021679)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8003274413021679)
,p_plug_template_id=>wwv_flow_imp.id(8001212578021679)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8003615133021679)
,p_plug_template_id=>wwv_flow_imp.id(8001212578021679)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8003881236021679)
,p_plug_template_id=>wwv_flow_imp.id(8001212578021679)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8004211067021681)
,p_plug_template_id=>wwv_flow_imp.id(8001212578021679)
,p_name=>'Sub Regions'
