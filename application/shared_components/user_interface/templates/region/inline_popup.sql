...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7961604982021653)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7961911607021653)
,p_plug_template_id=>wwv_flow_imp.id(7961604982021653)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7962190135021653)
,p_plug_template_id=>wwv_flow_imp.id(7961604982021653)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7962559469021653)
,p_plug_template_id=>wwv_flow_imp.id(7961604982021653)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7962816105021653)
,p_plug_template_id=>wwv_flow_imp.id(7961604982021653)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7963108832021653)
,p_plug_template_id=>wwv_flow_imp.id(7961604982021653)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7963449010021653)
,p_plug_template_id=>wwv_flow_imp.id(7961604982021653)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7963730896021653)
,p_plug_template_id=>wwv_flow_imp.id(7961604982021653)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7963991074021653)
,p_plug_template_id=>wwv_flow_imp.id(7961604982021653)
,p_name=>'Sub Regions'
