...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7951441517021646)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7951663303021648)
,p_plug_template_id=>wwv_flow_imp.id(7951441517021646)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7951991117021648)
,p_plug_template_id=>wwv_flow_imp.id(7951441517021646)
,p_name=>'Sub Regions'
