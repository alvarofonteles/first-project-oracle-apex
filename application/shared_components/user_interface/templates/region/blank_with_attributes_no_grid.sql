...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7929308501021634)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7929590815021634)
,p_plug_template_id=>wwv_flow_imp.id(7929308501021634)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7929880594021634)
,p_plug_template_id=>wwv_flow_imp.id(7929308501021634)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7930164452021634)
,p_plug_template_id=>wwv_flow_imp.id(7929308501021634)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7930534373021634)
,p_plug_template_id=>wwv_flow_imp.id(7929308501021634)
,p_name=>'Sub Regions'
