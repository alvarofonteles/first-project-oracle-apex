...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7956822513021649)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7957123067021649)
,p_plug_template_id=>wwv_flow_imp.id(7956822513021649)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7957449247021649)
,p_plug_template_id=>wwv_flow_imp.id(7956822513021649)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7957685579021649)
,p_plug_template_id=>wwv_flow_imp.id(7956822513021649)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7958055482021651)
,p_plug_template_id=>wwv_flow_imp.id(7956822513021649)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7958359620021651)
,p_plug_template_id=>wwv_flow_imp.id(7956822513021649)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7958613166021651)
,p_plug_template_id=>wwv_flow_imp.id(7956822513021649)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7958912847021651)
,p_plug_template_id=>wwv_flow_imp.id(7956822513021649)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7959220439021651)
,p_plug_template_id=>wwv_flow_imp.id(7956822513021649)
,p_name=>'Sub Regions'
