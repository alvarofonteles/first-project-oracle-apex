...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7996797899021676)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7997144381021676)
,p_plug_template_id=>wwv_flow_imp.id(7996797899021676)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7997418698021676)
,p_plug_template_id=>wwv_flow_imp.id(7996797899021676)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7997724060021676)
,p_plug_template_id=>wwv_flow_imp.id(7996797899021676)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7997964508021676)
,p_plug_template_id=>wwv_flow_imp.id(7996797899021676)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7998288930021676)
,p_plug_template_id=>wwv_flow_imp.id(7996797899021676)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7998602176021678)
,p_plug_template_id=>wwv_flow_imp.id(7996797899021676)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7998910246021678)
,p_plug_template_id=>wwv_flow_imp.id(7996797899021676)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7999216971021678)
,p_plug_template_id=>wwv_flow_imp.id(7996797899021676)
,p_name=>'Sub Regions'
