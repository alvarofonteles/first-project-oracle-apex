...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7935015652021637)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7935314832021637)
,p_plug_template_id=>wwv_flow_imp.id(7935015652021637)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7935616465021637)
,p_plug_template_id=>wwv_flow_imp.id(7935015652021637)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7935911709021637)
,p_plug_template_id=>wwv_flow_imp.id(7935015652021637)
,p_name=>'Sub Regions'
