...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7986582630021670)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7986902619021670)
,p_plug_template_id=>wwv_flow_imp.id(7986582630021670)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7987222252021670)
,p_plug_template_id=>wwv_flow_imp.id(7986582630021670)
,p_name=>'Tabs'
