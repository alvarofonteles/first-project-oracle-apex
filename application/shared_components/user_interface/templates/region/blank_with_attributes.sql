...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7927915280021634)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7928173547021634)
,p_plug_template_id=>wwv_flow_imp.id(7927915280021634)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7928514155021634)
,p_plug_template_id=>wwv_flow_imp.id(7927915280021634)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7928858063021634)
,p_plug_template_id=>wwv_flow_imp.id(7927915280021634)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7929149012021634)
,p_plug_template_id=>wwv_flow_imp.id(7927915280021634)
,p_name=>'Sub Regions'
