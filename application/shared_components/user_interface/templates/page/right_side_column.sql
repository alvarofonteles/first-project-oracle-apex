...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(7898642078021612)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7898880604021614)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7899172676021614)
,p_page_template_id=>wwv_flow_imp.id(7898642078021612)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7899538417021614)
,p_page_template_id=>wwv_flow_imp.id(7898642078021612)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7899813160021614)
,p_page_template_id=>wwv_flow_imp.id(7898642078021612)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7900137722021614)
,p_page_template_id=>wwv_flow_imp.id(7898642078021612)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7900444117021614)
,p_page_template_id=>wwv_flow_imp.id(7898642078021612)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7900701901021614)
,p_page_template_id=>wwv_flow_imp.id(7898642078021612)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7900995574021614)
,p_page_template_id=>wwv_flow_imp.id(7898642078021612)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7901260395021615)
,p_page_template_id=>wwv_flow_imp.id(7898642078021612)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7901649422021615)
,p_page_template_id=>wwv_flow_imp.id(7898642078021612)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7901902263021615)
,p_page_template_id=>wwv_flow_imp.id(7898642078021612)
