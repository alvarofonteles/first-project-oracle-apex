...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(7894892897021610)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7895201102021610)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7895529636021612)
,p_page_template_id=>wwv_flow_imp.id(7894892897021610)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7895849219021612)
,p_page_template_id=>wwv_flow_imp.id(7894892897021610)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7896153376021612)
,p_page_template_id=>wwv_flow_imp.id(7894892897021610)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7896443960021612)
,p_page_template_id=>wwv_flow_imp.id(7894892897021610)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7896704514021612)
,p_page_template_id=>wwv_flow_imp.id(7894892897021610)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7896979525021612)
,p_page_template_id=>wwv_flow_imp.id(7894892897021610)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7897359377021612)
,p_page_template_id=>wwv_flow_imp.id(7894892897021610)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7897636778021612)
,p_page_template_id=>wwv_flow_imp.id(7894892897021610)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7897877898021612)
,p_page_template_id=>wwv_flow_imp.id(7894892897021610)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7898233357021612)
,p_page_template_id=>wwv_flow_imp.id(7894892897021610)
